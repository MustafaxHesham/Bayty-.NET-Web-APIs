...
namespace EF_Modeling.Repositories
{
        ...
        GenericRepository<Advertisement, int>, IAdvertismentRepository
    {
        ...
        public async Task<Tuple<List<Advertisement>,int>> SearchAds(int pageSize, int pageNumber, double? minPrice = null, double? maxPrice = null, PropertyType? type = null, OrderDirectionPrice? order = null, bool? isRent = null, double? minArea = null, double? maxArea = null)
        {
