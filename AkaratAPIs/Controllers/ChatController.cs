...
namespace AkaratAPIs.Controllers
{
    ...
    public class ChatController : ControllerBase
    {
        ...
        [HttpGet]
        [Authorize]
        public async Task<ActionResult<IEnumerable<Message>>> GetMessageUserSpecific(string id1, string id2) => 
            Ok(await _dataStore.Messages.RetrieveMessageForTwoUsersAsync(id1, id2));
